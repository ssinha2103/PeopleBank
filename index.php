...
<head>
  ...
  <title>Welcome to People Bank</title>
  ...
  <!-- Font Awesome -->
  <script src="https://kit.fontawesome.com/dee5336736.js" crossorigin="anonymous"></script>
    ...
    <div class="container d-flex justify-content-between">
      ...
      <div class="logo">
        <!-- Uncomment below if you prefer to use an text logo -->
         <h1><a href="index.php">People Bank</a></h1>
  ...
  <section id="hero" class="clearfix">
    <div class="container" data-aos="fade-up">
      ...
      <div class="hero-info" data-aos="zoom-in" data-aos-delay="100">
        <h2>Welcome to the<br><span>People Bank</span><br>Services!</h2>
        <div>
    ...
    <!-- <section id="team">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-sm" data-aos="zoom-out" data-aos-delay="100">
            <div class="member">
              <img src="assets/img/team-1.jpg" class="img-fluid" alt="">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Anirudh Mishra</h4>
                  <span>19BCB0103 </span>
                  <div class="social">
          ...
          <div class="col-sm" data-aos="zoom-out" data-aos-delay="200">
            <div class="member">
              <img src="assets/img/team-2.jpg" class="img-fluid" alt="">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Sudarshan Sinha</h4>
                  <span>19BCB0081</span>
                  <div class="social">
                    <a href=""><i class="bi bi-twitter"></i></a>
                    <a href=""><i class="bi bi-facebook"></i></a>
          ...
          <div class="col-lg-6">
            <div class="row">
              <div class="col-md-5 info">
                ...
                <p><b>Anirudh Mishra</p></b>
              </div>
              <div class="col-md-4 info">
                <!-- <i class="fas fa-user-cog"></i> -->
                <p><b>Sudarshan Sinha</b></p>
              </div>
              <div class="col-md-3 info">
                <!-- <i class="bi bi-phone"></i> -->

                <!-- <i class="fas fa-user-cog"></i> -->
                <p><b>Masettypreetham</b></p>
              </div>
            </div>
